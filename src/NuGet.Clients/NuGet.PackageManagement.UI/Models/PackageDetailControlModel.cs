...
namespace NuGet.PackageManagement.UI
{
    ...
    public class PackageDetailControlModel : DetailControlModel
    {
        ...
        private PackageDetailControlModel(INuGetSolutionManagerService solutionManager, IEnumerable<IProjectContextInfo> projects)
            : base(projects)
        {
        ...
        public static PackageDetailControlModel Create(INuGetSolutionManagerService solutionManager, IEnumerable<IProjectContextInfo> projects)
        {
